...
public class XLSXMetaData {
	 ...
	 */
	public void process(OPCPackage xlsxPackage) throws IOException, OpenXML4JException, SAXException {
	...
	public boolean isNumerical(int rowAnnotations) {
		return RegexUtils.matches(TextUtils.NUMBER_PATTERN, CollectionUtils.tail(mRow, rowAnnotations));

	}

	public int estimateRowAnnotations() {
